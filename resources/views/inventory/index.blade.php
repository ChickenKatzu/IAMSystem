                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    $category = $categoryLabels[$item->category] ?? ['label' => ucfirst($item->category), 'class' => 'secondary'];
                                @endphp
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-4">
                                <img src="https://via.placeholder.com/150?text=No+Data" alt="No Data" class="mb-3" style="opacity: 0.5">
